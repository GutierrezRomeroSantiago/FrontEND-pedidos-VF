...
export class CrearUsuarioComponent implements OnInit {
  ...
  //Función para la obtención de los usuarios de la coleccion users
  getUser() {
  ...
  //Función para el eliminado de usuarios de la aplicación
  ...
  //Función para añadir usuarios a la aplicación
  addUser(
    _usuario: string,
    _password: string,
  ) {
