...
export class ListarPedidoComponent implements OnInit {
  ...
  //Obtener pedidos para su posterior respresentación y tratado
  getPedBasic() {
  ...
  //Mandamos info a la rest api para eliminar un pedido
  ...
  cambiarEstado(id: any, estado:any) {
    this.pedidoService.editaEst(id, estado).subscribe(data => {
      window.location.reload();
    })
  }
