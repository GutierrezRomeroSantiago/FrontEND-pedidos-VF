...
export class Grafico2Component implements OnInit {
  ...
  //Función mediante la que conocemos los costes de cada pedido y costes totales, ademas de la cantidad de pedidos de cada tipo
  // Posteriormente cargamos los datos en dos gráficos diferentes
  getTipo() {
    let tmpPedido: any
    let count1: any = 0
    let count2: any = 0
